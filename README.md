...
- **Downstream AI runtime**: supported package exports for canonical gateway configuration, provider probes, `BudgetTracker`, and durable spend reservations. Integration and isolation contract: [`docs/guides/downstream-ai-runtime.md`](docs/guides/downstream-ai-runtime.md).
