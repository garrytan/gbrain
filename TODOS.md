...
- [x] **P3 — `schema lint --with-db` has no test.** **Completed:** v0.51.1.0 (2026-09-16). `test/schema-cli-lint-with-db.test.ts` drives isolated CLI subprocesses for DB-plane pack resolution, flag ordering, missing packs, JSON output, invalid arguments, and plain-lint separation (12 passing cases).
