...
const LEDGER: Record<string, string> = {
  ...
  get_skill_asset: 'test/fixtures/shared-skills-transport-cases.ts',
  put_skill: 'test/fixtures/shared-skills-transport-cases.ts',
  delete_skill: 'test/fixtures/shared-skills-transport-cases.ts',
  get_skill_policy: 'test/shared-skills-operator-operations.test.ts',
  set_skill_policy: 'test/shared-skills-operator-operations.test.ts',
  get_skill_retention: 'test/shared-skills-operator-operations.test.ts',
  prune_skill_revisions: 'test/shared-skills-operator-operations.test.ts',
  retain_skill_revision: 'test/shared-skills-operator-operations.test.ts',
  import_skill_proposal: 'test/shared-skills-proposal-cli.test.ts',
  join_brain: 'test/fixtures/shared-skills-transport-cases.ts',
  sync_brain_skills: 'test/fixtures/shared-skills-transport-cases.ts',
  leave_brain: 'test/shared-skills-membership.test.ts',
  ...
  attachment_begin: 'test/attachments.test.ts',
  attachment_write: 'test/attachments.test.ts',
  attachment_complete: 'test/attachments.test.ts',
  attachment_abort: 'test/attachments.test.ts',
  attachment_list: 'test/attachments.test.ts',
  attachment_read: 'test/attachments.test.ts',
