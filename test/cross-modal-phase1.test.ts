...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 16 (cross-modal still appended; 15→16 type filter fold)', () => {
    ...
    // 15→16: per-call page type filter (type=) separates filtered and
    // unfiltered query-cache rows.
