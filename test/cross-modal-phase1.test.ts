...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 20 (cross-modal still appended; 16→17 degradation-stamp epoch; 17→18 autocut weak-top floor #1863; 18→20 qwen3 query-side instruct)', () => {
