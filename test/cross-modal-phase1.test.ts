...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 29 (cross-modal still appended; …; 24→25 keywordOrFallback knob kof= #3617; 25→26 salience/recency + intent_patterns fold #4415; 26→27 adaptive-return gate + intent fold E5b/F11; 27→28 compiledTruthBoost synthetic-row suppression #4256; 28→29 preferred-type cache isolation)', () => {
    ...
    // 28→29: preferred-type candidate generation and cache segmentation.
