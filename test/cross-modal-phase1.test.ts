...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 18 (cross-modal still appended; 14→15 FTS language fold; 17→18 qwen3 query-side instruct)', () => {
    ...
    // 17→18: qi= qwen3 query-side Instruct template.
