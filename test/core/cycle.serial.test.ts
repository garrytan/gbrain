...
describe('runCycle — yieldBetweenPhases hook', () => {
  ...
  test('hook is called between every phase', async () => {
    ...
    // v0.36.0.0: 16 phases (added `propose_takes`, `grade_takes`, `calibration_profile` between consolidate and embed).
  ...
  test('hook exceptions do not abort the cycle', async () => {
    ...
    // v0.36.0.0: 16 phases (Hindsight calibration wave adds propose_takes, grade_takes, calibration_profile).
