 ...
 * paths (ship-audit gap fill; the committed test/extract-cross-source-links
 * .test.ts covers only the pure resolveCandidateSources helper + the config
 * ladder). Pinned here:
 *
 ...
 * test/extract-source-aware.test.ts.
 */
