...
describe('KNOBS_HASH_VERSION', () => {
  it('is 27 (…; 23→24 negative-offset cache-skip gap #4358 residual; 24→25 keywordOrFallback knob kof= #3617; 25→26 salience/recency + intent_patterns fold #4415; 26→27 compiledTruthBoost synthetic-row suppression #4256/#3695)', () => {
