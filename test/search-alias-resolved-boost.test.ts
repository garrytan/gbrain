...
describe('KNOBS_HASH_VERSION', () => {
  it('is 16 (14→15 folds the resolved FTS configuration name; 15→16 adds the acm= autocut minKeep floor — a minKeep=1 write must not serve a raised-floor lookup)', () => {
