...
describe('KNOBS_HASH_VERSION', () => {
  it('is 18 (14→15 folds the resolved FTS configuration name; 17→18 adds the qi= qwen3 query-side instruct, so rows written before either switch become unreachable)', () => {
