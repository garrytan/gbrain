 ...
 *  LIVE voyage default since v0.47.10 — NOT an exposure. Use
...
describe('detectZeExposure — reranker + custom-column axes', () => {
  test('implicit bundle reranker (nothing configured) is the live voyage default → NOT an exposure (v0.47.10)', async () => {
