...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 16 (…; 11→12 hard-excludes #2825; 12→13 embedding-provider migration #3390; 14→15 FTS language)', () => {
    ...
    // 15→16: acm= (autocut minKeep floor) — the floor changes how many rows
    // survive the cut, so writes and lookups must agree on it.
