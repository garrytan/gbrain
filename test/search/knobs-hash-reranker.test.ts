...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 13 (…; 10→11 asymmetric input_type #1400; 11→12 hard-excludes #2825; 12→13 autocut weak-top floor)', () => {
    ...
    // 12→13: autocut weak-top floor (acmts=) — the floor shifts whether
