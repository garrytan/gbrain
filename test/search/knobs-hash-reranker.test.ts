...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 18 (…; 11→12 hard-excludes #2825; 12→13 embedding-provider migration #3390; 14→15 FTS language; 17→18 qwen3 query-side instruct)', () => {
    ...
    // 17→18: qi= (qwen3 query-side Instruct template) joins the key.
