...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 12 (…; 9→10 relational recall; 10→11 asymmetric input_type #1400; 11→12 autocut weak-top floor)', () => {
    ...
    // 11→12: autocut weak-top floor (acmts=) — the floor shifts whether
