...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 17 (…; 11→12 hard-excludes #2825; 12→13 embedding-provider migration #3390; 14→15 FTS language)', () => {
    ...
    // 16→17: kof= (keyword AND→OR fallback knob) joins the key.
