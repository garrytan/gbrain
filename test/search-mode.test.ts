...
describe('v0.42.3.0 — autocut knobs', () => {
  test('KNOBS_HASH_VERSION is 21 (16→17 degradation-stamp epoch; 17→18 autocut weak-top floor #1863; 18→21 autocut minKeep floor amk=)', () => {
    // 18→21: amk= (autocut minKeep floor) joins the key — a minKeep=1 write
    // must not serve a raised-floor lookup (19/20 = siblings #3617/#3584).
    expect(KNOBS_HASH_VERSION).toBe(21);
  });
  ...
  test('knobsHash includes amk= — floors 1 vs 6 differ (cache contamination prevention)', () => {
