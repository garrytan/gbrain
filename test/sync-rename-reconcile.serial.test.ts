...
describe('#3583 review: GATE17 — the derived-authority move cannot overwrite a manual page', () => {
...
describe('#3583 review: GATE19 — metadata joins the content rail', () => {
...
describe('#3583 review: GATE20 — inference joins the signal parse', () => {
