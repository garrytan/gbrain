...
const EXPECTED_EXPORTS: ExpectedExport[] = [
  ...
  { subpath: 'gbrain/ai/config', canary: ['buildGatewayConfig'] },
  { subpath: 'gbrain/ai/probes', canary: ['probeOpenAICompat', 'probeLlamaServer'] },
  { subpath: 'gbrain/budget/tracker', canary: ['BudgetTracker', 'BudgetExhausted'] },
  { subpath: 'gbrain/budget/ledger', canary: ['BudgetLedger', 'BudgetError'] },
  { subpath: 'gbrain/budget/mcp', canary: ['reserve', 'settle', 'BudgetExceededError'] },
