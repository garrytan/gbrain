 ...
 * hardcoded-default surface: `gemini` pointed at `google:gemini-3-pro` (only
 * ever a preview id, shut down) for a month because nothing pinned alias
 * targets to a recipe list. The guard only works if recipes list LIVE models
 * — do not re-add a retired model to a recipe to quiet this test.
 *
