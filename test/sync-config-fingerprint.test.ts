/**
 * #2157 follow-on (migration v120 — `sources.config_fingerprint`).
 *
 ...
 *
 *   - Migration v120 actually adds the column (regression guard against
 ...
 *   - NULL fingerprint on pre-v120 rows treats as "not stamped" so a
...
describe('migration v120 — sources.config_fingerprint column', () => {
...
describe('readConfigFingerprint / writeConfigFingerprint — persistence round-trip', () => {
  ...
  test('NULL on never-stamped row (pre-v120 semantics)', async () => {
