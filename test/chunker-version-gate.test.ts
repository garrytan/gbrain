/**
 * CHUNKER_VERSION bump history + SP-1 gate.
 *
...
describe('Layer 12 — CHUNKER_VERSION constant', () => {
  test('bumped to 5 for decorated Python definitions', () => {
    ...
    // v5: Python decorated definitions (top-level symbols + scoped methods).
