...
- Implements the upstream GitHub awesome-copilot skill intent for `excalidraw-diagram-generator`: Generate Excalidraw diagrams from natural language descriptions. Use when asked to
