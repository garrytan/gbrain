...
triggers:
  ...
  - "issue fields migration"
  - "awesome copilot issue fields migration"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `issue-fields-migration`: Bulk-migrate metadata to GitHub issue fields from two sources: repo labels (e.g. priority labels to a Priority field) and Project V2 fields. Use when users say
