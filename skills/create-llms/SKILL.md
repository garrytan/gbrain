...
- Implements the upstream GitHub awesome-copilot skill intent for `create-llms`: Create an llms.txt file from scratch based on repository structure following the llms.txt specification at https://llmstxt.org/
