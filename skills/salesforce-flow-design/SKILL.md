...
triggers:
  ...
  - "salesforce flow design"
  - "awesome copilot salesforce flow design"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `salesforce-flow-design`: Salesforce Flow architecture decisions, flow type selection, bulk safety validation, and fault handling standards. Use this skill when designing or reviewing Record-Triggered, Screen, Autolaunched, Scheduled, or Platform
