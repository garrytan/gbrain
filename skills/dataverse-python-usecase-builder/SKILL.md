...
- Implements the upstream GitHub awesome-copilot skill intent for `dataverse-python-usecase-builder`: Generate complete solutions for specific Dataverse SDK use cases with architecture recommendations
