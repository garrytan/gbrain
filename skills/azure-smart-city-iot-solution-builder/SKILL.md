...
triggers:
  ...
  - "azure smart city iot solution builder"
  - "awesome copilot azure smart city iot solution builder"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `azure-smart-city-iot-solution-builder`: Design and plan end-to-end Azure IoT and Smart City solutions: requirements, architecture, security, operations, cost, and a phased delivery plan with concrete implementation artifacts.
