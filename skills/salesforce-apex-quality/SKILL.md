...
triggers:
  ...
  - "salesforce apex quality"
  - "awesome copilot salesforce apex quality"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `salesforce-apex-quality`: Apex code quality guardrails for Salesforce development. Enforces bulk-safety rules (no SOQL/DML in loops), sharing model requirements, CRUD/FLS security, SOQL injection prevention, PNB test coverage (Positive / Negative
