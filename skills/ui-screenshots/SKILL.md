...
triggers:
  - "ui-screenshots"
  - "ui screenshots"
  - "awesome copilot ui screenshots"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `ui-screenshots`: Capture screenshots of web apps during development using Playwright and PIL. Supports full-page captures, interactive states, and an iterate-on-crop workflow that avoids slow re-screenshots.
