...
- Implements the upstream GitHub awesome-copilot skill intent for `add-educational-comments`: Add educational comments to the file specified, or prompt asking for file to comment if one is not provided.
