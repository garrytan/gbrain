...
triggers:
  ...
  - "python azure iot edge modules"
  - "awesome copilot python azure iot edge modules"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `python-azure-iot-edge-modules`: Build and operate Python Azure IoT Edge modules with robust messaging, deployment manifests, observability, and production readiness checks.
