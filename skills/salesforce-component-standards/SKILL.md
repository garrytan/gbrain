...
triggers:
  ...
  - "salesforce component standards"
  - "awesome copilot salesforce component standards"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `salesforce-component-standards`: Quality standards for Salesforce Lightning Web Components (LWC), Aura components, and Visualforce pages. Covers SLDS 2 compliance, accessibility (WCAG 2.1 AA), data access pattern selection, component communication rules
