...
- Implements the upstream GitHub awesome-copilot skill intent for `breakdown-plan`: Issue Planning and Automation prompt that generates comprehensive project plans with Epic > Feature > Story/Enabler > Test hierarchy, dependencies, priorities, and automated tracking.
