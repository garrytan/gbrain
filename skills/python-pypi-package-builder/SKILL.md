...
triggers:
  ...
  - "python pypi package builder"
  - "awesome copilot python pypi package builder"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `python-pypi-package-builder`: End-to-end skill for building, testing, linting, versioning, and publishing a production-grade Python library to PyPI. Covers all four build backends (setuptools+setuptools_scm, hatchling, flit, poetry), PEP 440 versioni
