...
- Implements the upstream GitHub awesome-copilot skill intent for `php-mcp-server-generator`: Generate a complete PHP Model Context Protocol server project with tools, resources, prompts, and tests using the official PHP SDK
