...
triggers:
  ...
  - "qdrant search quality diagnosis"
  - "awesome copilot qdrant search quality diagnosis"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-search-quality-diagnosis`: Diagnoses Qdrant search quality issues. Use when someone reports
