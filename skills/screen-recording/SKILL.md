...
triggers:
  - "screen-recording"
  - "screen recording"
  - "awesome copilot screen recording"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `screen-recording`: Create annotated animated GIF demos and screen recordings for pull requests and documentation. Covers frame capture, timing, imageio-based GIF creation, and per-frame annotation workflows.
