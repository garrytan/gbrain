...
- Implements the upstream GitHub awesome-copilot skill intent for `code-exemplars-blueprint-generator`: Technology-agnostic prompt generator that creates customizable AI prompts for scanning codebases and identifying high-quality code exemplars. Supports multiple programming languages (.NET, Java, JavaScript, TypeScript, R
