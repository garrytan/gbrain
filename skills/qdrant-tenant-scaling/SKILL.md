...
triggers:
  ...
  - "qdrant tenant scaling"
  - "awesome copilot qdrant tenant scaling"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-tenant-scaling`: Guides Qdrant multi-tenant scaling. Use when someone asks
