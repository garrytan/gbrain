...
triggers:
  ...
  - "gtm developer ecosystem"
  - "awesome copilot gtm developer ecosystem"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-developer-ecosystem`: Build and scale developer-led adoption through ecosystem programs. Use when deciding open vs curated ecosystems, building developer programs, scaling platform adoption, or designing student program pipelines.
