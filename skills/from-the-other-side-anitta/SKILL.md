...
triggers:
  ...
  - "from the other side anitta"
  - "awesome copilot from the other side anitta"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `from-the-other-side-anitta`: Rigorous challenge profile for Anitta: assumption checks, evidence calibration, and defensible reasoning patterns for Ember collaboration.
