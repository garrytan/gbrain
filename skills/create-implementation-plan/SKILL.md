...
- Implements the upstream GitHub awesome-copilot skill intent for `create-implementation-plan`: Create a new implementation plan file for new features, refactoring existing code or upgrading packages, design, architecture or infrastructure.
