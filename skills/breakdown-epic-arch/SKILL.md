...
- Implements the upstream GitHub awesome-copilot skill intent for `breakdown-epic-arch`: Prompt for creating the high-level technical architecture for an Epic, based on a Product Requirements Document.
