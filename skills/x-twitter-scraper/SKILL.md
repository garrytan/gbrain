...
triggers:
  - "x-twitter-scraper"
  - "x twitter scraper"
  - "awesome copilot x twitter scraper"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `x-twitter-scraper`: Build GitHub Copilot workflows with Xquik X API SDKs, REST endpoints, MCP tools, TweetClaw OpenClaw plugin installs, signed webhooks, tweet search, user lookup, follower exports, media actions, and agent automation.
