...
- Implements the upstream GitHub awesome-copilot skill intent for `github-copilot-starter`: Set up complete GitHub Copilot configuration for a new project based on technology stack
