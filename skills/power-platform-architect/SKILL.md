...
triggers:
  ...
  - "power platform architect"
  - "awesome copilot power platform architect"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `power-platform-architect`: Use this skill when the user needs to transform business requirements, use case descriptions, or meeting transcripts into a technical Power Platform solution architecture, including component selection and Mermaid.js dia
