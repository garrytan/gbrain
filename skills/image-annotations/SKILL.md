...
triggers:
  - "image-annotations"
  - "image annotations"
  - "awesome copilot image annotations"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `image-annotations`: Annotate screenshots, diagrams, and images with callout rectangles, arrows, labels, and color-coded highlights using PIL. Includes rules for animated GIF annotations with timing and pacing.
