...
triggers:
  ...
  - "from the other side wiggins"
  - "awesome copilot from the other side wiggins"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `from-the-other-side-wiggins`: Narrative and synthesis profile for Wiggins: framing, explanation, and audience-aware communication patterns for Ember sessions.
