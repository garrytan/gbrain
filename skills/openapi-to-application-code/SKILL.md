...
- Implements the upstream GitHub awesome-copilot skill intent for `openapi-to-application-code`: Generate a complete, production-ready application from an OpenAPI specification
