...
- Implements the upstream GitHub awesome-copilot skill intent for `python-mcp-server-generator`: Generate a complete MCP server project in Python with tools, resources, and proper configuration
