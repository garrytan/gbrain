...
```json
{
  ...
  "contact_email": "email-redacted.example",
...
- Implements the upstream GitHub awesome-copilot skill intent for `mcp-create-declarative-agent`: Skill converted from mcp-create-declarative-agent.prompt.md
