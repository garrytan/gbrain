...
- Implements the upstream GitHub awesome-copilot skill intent for `azure-deployment-preflight`: Performs comprehensive preflight validation of Bicep deployments to Azure, including template syntax validation, what-if analysis, and permission checks. Use this skill before any deployment to Azure to preview changes, 
