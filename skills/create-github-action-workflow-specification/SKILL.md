...
- Implements the upstream GitHub awesome-copilot skill intent for `create-github-action-workflow-specification`: Create a formal specification for an existing GitHub Actions CI/CD workflow, optimized for AI consumption and workflow maintenance.
