...
triggers:
  ...
  - "gtm partnership architecture"
  - "awesome copilot gtm partnership architecture"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-partnership-architecture`: Build and scale partner ecosystems that drive revenue and platform adoption. Use when building partner programs from scratch, tiering partnerships, managing co-marketing, making build-vs-partner decisions, or structuring
