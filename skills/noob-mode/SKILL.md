...
- Implements the upstream GitHub awesome-copilot skill intent for `noob-mode`: Plain-English translation layer for non-technical Copilot CLI users. Translates every approval prompt, error message, and technical output into clear, jargon-free English with color-coded risk indicators.
