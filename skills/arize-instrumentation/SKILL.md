...
triggers:
  ...
  - "arize instrumentation"
  - "awesome copilot arize instrumentation"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `arize-instrumentation`: Adds Arize AX tracing to an LLM application for the first time. Follows a two-phase agent-assisted flow to analyze the codebase then implement instrumentation after user confirmation. Use when the user wants to instrumen
