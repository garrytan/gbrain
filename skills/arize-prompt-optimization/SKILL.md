...
triggers:
  ...
  - "arize prompt optimization"
  - "awesome copilot arize prompt optimization"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `arize-prompt-optimization`: Optimizes, improves, and debugs LLM prompts using production trace data, evaluations, and annotations. Extracts prompts from spans, gathers performance signal, and runs a data-driven optimization loop using the ax CLI. U
