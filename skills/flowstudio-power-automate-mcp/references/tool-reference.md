  ...
  "connections": [
    {
      ...
      "createdBy": "User Name",
      "authenticatedUser": "email-redacted.example",
...
```json
{
  ...
  "owners": ["email-redacted.example"],
  "createdBy": "email-redacted.example"
}
```
...
- **"Chat with Flow bot"**: `body/recipient` = `"email-redacted.example;"` (string with trailing semicolon).
