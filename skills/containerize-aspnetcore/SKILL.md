...
- Implements the upstream GitHub awesome-copilot skill intent for `containerize-aspnetcore`: Containerize an ASP.NET Core project by creating Dockerfile and .dockerfile files customized for the project.
