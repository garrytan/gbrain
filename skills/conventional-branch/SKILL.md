...
triggers:
  - "conventional-branch"
  - "conventional branch"
  - "awesome copilot conventional branch"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `conventional-branch`: Create Git branches following the Conventional Branch specification (feature/, bugfix/, hotfix/, release/, chore/). Use when creating a new branch, naming a branch, or checking whether a branch name complies with the spe
