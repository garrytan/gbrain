...
- Implements the upstream GitHub awesome-copilot skill intent for `ruby-mcp-server-generator`: Generate a complete Model Context Protocol server project in Ruby using the official MCP Ruby SDK gem.
