...
triggers:
  - "vardoger-analyze"
  - "vardoger analyze"
  - "awesome copilot vardoger analyze"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `vardoger-analyze`: Use when the user asks to personalize the GitHub Copilot CLI assistant, adapt Copilot to their style, use vardoger, or analyze their Copilot CLI conversation history. Reads the local session directory at `~/.copilot/sess
