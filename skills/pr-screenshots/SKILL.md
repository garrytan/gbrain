...
triggers:
  - "pr-screenshots"
  - "pr screenshots"
  - "awesome copilot pr screenshots"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `pr-screenshots`: Embed before/after screenshots and annotated images in pull request descriptions. Covers PR description patterns, image upload for Azure DevOps and GitHub, and sizing best practices.
