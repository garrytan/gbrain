...
triggers:
  - "gtm-0-to-1-launch"
  - "gtm 0 to 1 launch"
  - "awesome copilot gtm 0 to 1 launch"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-0-to-1-launch`: Launch new products from idea to first customers. Use when launching products, finding early adopters, building launch week playbooks, diagnosing why adoption stalls, or learning that press coverage does not equal growth
