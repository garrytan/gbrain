...
triggers:
  ...
  - "data breach blast radius"
  - "awesome copilot data breach blast radius"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `data-breach-blast-radius`: Pre-breach impact analysis: inventories sensitive data (PII, PHI, PCI-DSS, credentials), traces data flows, scores exposure vectors, and produces a regulatory blast radius report with fine ranges sourced verbatim from GD
