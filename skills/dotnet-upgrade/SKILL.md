...
- Implements the upstream GitHub awesome-copilot skill intent for `dotnet-upgrade`: Ready-to-use prompts for comprehensive .NET framework upgrade analysis and execution
