...
- Implements the upstream GitHub awesome-copilot skill intent for `drawio`: Generate draw.io diagrams as .drawio files and export to PNG/SVG/PDF with embedded XML
