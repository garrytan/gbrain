...
triggers:
  - "webapp-testing"
  - "webapp testing"
  - "awesome copilot webapp testing"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `webapp-testing`: Toolkit for interacting with and testing local web applications using Playwright. Supports verifying frontend functionality, debugging UI behavior, capturing browser screenshots, and viewing browser logs.
