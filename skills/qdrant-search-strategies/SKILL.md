...
triggers:
  ...
  - "qdrant search strategies"
  - "awesome copilot qdrant search strategies"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-search-strategies`: Guides Qdrant search strategy selection. Use when someone asks
