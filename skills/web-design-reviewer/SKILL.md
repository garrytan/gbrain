...
- Implements the upstream GitHub awesome-copilot skill intent for `web-design-reviewer`: This skill enables visual inspection of websites running locally or remotely to identify and fix design issues. Triggers on requests like
