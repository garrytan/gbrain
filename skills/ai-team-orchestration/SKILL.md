...
triggers:
  ...
  - "ai team orchestration"
  - "awesome copilot ai team orchestration"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `ai-team-orchestration`: Bootstrap and run a multi-agent AI development team. Use when: starting a new software project with AI agents, setting up parallel dev/QA teams, creating sprint plans, writing brainstorm prompts with distinct agent voice
