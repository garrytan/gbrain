...
triggers:
  - "prompt-optimizer"
  - "prompt optimizer"
  - "awesome copilot prompt optimizer"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `prompt-optimizer`: Turn any rough prompt, half-formed idea, or task description into a finished, ready-to-send prompt optimized for any LLM model inside a chat interface — NOT the API. Use this skill whenever the user wants to write, rewri
