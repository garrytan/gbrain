...
triggers:
  ...
  - "adobe illustrator scripting"
  - "awesome copilot adobe illustrator scripting"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `adobe-illustrator-scripting`: Write, debug, and optimize Adobe Illustrator automation scripts using ExtendScript (JavaScript/JSX). Use when creating or modifying scripts that manipulate documents, layers, paths, text frames, colors, symbols, artboard
