...
- Implements the upstream GitHub awesome-copilot skill intent for `shuffle-json-data`: Shuffle repetitive JSON objects safely by validating schema consistency before randomising entries.
