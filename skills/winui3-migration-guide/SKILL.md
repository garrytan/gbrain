...
- Implements the upstream GitHub awesome-copilot skill intent for `winui3-migration-guide`: UWP-to-WinUI 3 migration reference. Maps legacy UWP APIs to correct Windows App SDK equivalents with before/after code snippets. Covers namespace changes, threading (CoreDispatcher to DispatcherQueue), windowing (CoreWin
