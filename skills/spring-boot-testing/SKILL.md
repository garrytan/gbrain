...
triggers:
  - "spring-boot-testing"
  - "spring boot testing"
  - "awesome copilot spring boot testing"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `spring-boot-testing`: Expert Spring Boot 4 testing specialist that selects the best Spring Boot testing techniques for your situation with Junit 6 and AssertJ.
