...
triggers:
  - "incident-postmortem"
  - "incident postmortem"
  - "awesome copilot incident postmortem"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `incident-postmortem`: Use when an outage, production incident, or significant service degradation has occurred and the team needs to write a structured blameless post-mortem. Triggers on phrases like
