...
- Implements the upstream GitHub awesome-copilot skill intent for `kotlin-mcp-server-generator`: Generate a complete Kotlin MCP server project with proper structure, dependencies, and implementation using the official io.modelcontextprotocol:kotlin-sdk library.
