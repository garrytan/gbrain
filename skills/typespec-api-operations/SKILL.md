...
- Implements the upstream GitHub awesome-copilot skill intent for `typespec-api-operations`: Add GET, POST, PATCH, and DELETE operations to a TypeSpec API plugin with proper routing, parameters, and adaptive cards
