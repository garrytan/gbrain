...
- Implements the upstream GitHub awesome-copilot skill intent for `nano-banana-pro-openrouter`: Generate or edit images via OpenRouter with the Gemini 3 Pro Image model. Use for prompt-only image generation, image edits, and multi-image compositing; supports 1K/2K/4K output.
