...
- Raw source preserved for provenance via `cortex files upload-raw`
...
2. **Upload raw source.** Save the fetched content for provenance: `cortex files upload-raw <file> --page <slug>`
...
6. **Sync.** `cortex sync` to update the index.
