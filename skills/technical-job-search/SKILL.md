...
triggers:
  ...
  - "technical job search"
  - "awesome copilot technical job search"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `technical-job-search`: Use this skill when a software engineer asks for help with job search tasks: parsing or analyzing a job description, tailoring a CV/resume, writing a cover letter, evaluating a job offer, or drafting a post-interview fol
