...
- Implements the upstream GitHub awesome-copilot skill intent for `write-coding-standards-from-file`: Write a coding standards document for a project using the coding styles from the file(s) and/or folder(s) passed as arguments in the prompt.
