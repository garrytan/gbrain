...
- sendEmail('email-redacted.example', 'Hello', '...');
...
+
+ // Usage
+ const email = Email.create('email-redacted.example');
...
- Implements the upstream GitHub awesome-copilot skill intent for `refactor`: Surgical code refactoring to improve maintainability without changing behavior. Covers extracting functions, renaming variables, breaking down god functions, improving type safety, eliminating code smells, and applying d
