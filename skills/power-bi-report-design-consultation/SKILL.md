...
- Implements the upstream GitHub awesome-copilot skill intent for `power-bi-report-design-consultation`: Power BI report visualization design prompt for creating effective, user-friendly, and accessible reports with optimal chart selection and layout design.
