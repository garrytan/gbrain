...
triggers:
  - "semantic-kernel"
  - "semantic kernel"
  - "awesome copilot semantic kernel"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `semantic-kernel`: Create, update, refactor, explain, or review Semantic Kernel solutions using shared guidance plus language-specific references for .NET and Python.
