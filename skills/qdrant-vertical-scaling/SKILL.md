...
triggers:
  ...
  - "qdrant vertical scaling"
  - "awesome copilot qdrant vertical scaling"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-vertical-scaling`: Guides Qdrant vertical scaling decisions. Use when someone asks
