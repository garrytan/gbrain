...
- Implements the upstream GitHub awesome-copilot skill intent for `finnish-humanizer`: Detect and remove AI-generated markers from Finnish text, making it sound like a native Finnish speaker wrote it. Use when asked to
