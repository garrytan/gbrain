...
- Implements the upstream GitHub awesome-copilot skill intent for `csharp-docs`: Ensure that C# types are documented with XML comments and follow best practices for documentation.
