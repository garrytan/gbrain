...
triggers:
  ...
  - "pester should migration"
  - "awesome copilot pester should migration"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `pester-should-migration`: Experimental (preview) Pester skill for migrating classic Should -Be (v5) assertion syntax to the new Should-* (v6) assertions (note the hyphen, no space), e.g. `Should -Be` -> `Should-Be`, `Should -Not -Be` -> `Should-N
