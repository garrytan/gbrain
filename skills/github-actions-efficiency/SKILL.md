...
triggers:
  ...
  - "github actions efficiency"
  - "awesome copilot github actions efficiency"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `github-actions-efficiency`: Audit GitHub Actions workflow efficiency and recommend fixes to reduce CI minutes and costs.
