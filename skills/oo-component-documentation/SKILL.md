...
triggers:
  ...
  - "oo component documentation"
  - "awesome copilot oo component documentation"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `oo-component-documentation`: Create or update standardized object-oriented component documentation using a shared template plus mode-specific guidance for new and existing docs.
