...
- Implements the upstream GitHub awesome-copilot skill intent for `agentic-workflows`: Route gh-aw workflow design/create/debug/upgrade requests to the right prompts.
