...
triggers:
  ...
  - "qdrant horizontal scaling"
  - "awesome copilot qdrant horizontal scaling"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-horizontal-scaling`: Diagnoses and guides Qdrant horizontal scaling decisions. Use when someone asks
