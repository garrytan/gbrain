...
triggers:
  ...
  - "gtm board and investor communication"
  - "awesome copilot gtm board and investor communication"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-board-and-investor-communication`: Board meeting preparation, investor updates, and executive communication. Use when preparing board decks, writing investor updates, handling bad news with the board, structuring QBRs, or building board-level metric disci
