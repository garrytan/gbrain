...
- Implements the upstream GitHub awesome-copilot skill intent for `typescript-mcp-server-generator`: Generate a complete MCP server project in TypeScript with tools, resources, and proper configuration
