...
- Implements the upstream GitHub awesome-copilot skill intent for `ai-prompt-engineering-safety-review`: Comprehensive AI prompt engineering safety review and improvement prompt. Analyzes prompts for safety, bias, security vulnerabilities, and effectiveness while providing detailed improvement recommendations with extensive
