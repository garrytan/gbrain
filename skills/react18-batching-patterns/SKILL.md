...
- Implements the upstream GitHub awesome-copilot skill intent for `react18-batching-patterns`: Provides exact patterns for diagnosing and fixing automatic batching regressions in React 18 class components. Use this skill whenever a class component has multiple setState calls in an async method, inside setTimeout, 
