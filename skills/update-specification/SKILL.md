...
- Implements the upstream GitHub awesome-copilot skill intent for `update-specification`: Update an existing specification file for the solution, optimized for Generative AI consumption based on new requirements or updates to any existing code.
