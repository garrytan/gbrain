...
- Implements the upstream GitHub awesome-copilot skill intent for `swift-mcp-server-generator`: Generate a complete Model Context Protocol server project in Swift using the official MCP Swift SDK package.
