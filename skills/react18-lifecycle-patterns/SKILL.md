...
triggers:
  ...
  - "react18 lifecycle patterns"
  - "awesome copilot react18 lifecycle patterns"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `react18-lifecycle-patterns`: Provides exact before/after migration patterns for the three unsafe class component lifecycle methods - componentWillMount, componentWillReceiveProps, and componentWillUpdate - targeting React 18.3.1. Use this skill when
