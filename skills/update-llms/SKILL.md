...
- Implements the upstream GitHub awesome-copilot skill intent for `update-llms`: Update the llms.txt file in the root folder to reflect changes in documentation or specifications following the llms.txt specification at https://llmstxt.org/
