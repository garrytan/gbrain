...
- Implements the upstream GitHub awesome-copilot skill intent for `declarative-agents`: Complete development kit for Microsoft 365 Copilot declarative agents with three comprehensive workflows (basic, advanced, validation), TypeSpec support, and Microsoft 365 Agents Toolkit integration
