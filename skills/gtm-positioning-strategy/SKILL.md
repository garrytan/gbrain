...
triggers:
  ...
  - "gtm positioning strategy"
  - "awesome copilot gtm positioning strategy"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-positioning-strategy`: Find and own a defensible market position. Use when messaging sounds like competitors, conversion is weak despite awareness, repositioning a product, or testing positioning claims. Includes Crawl-Walk-Run rollout methodo
