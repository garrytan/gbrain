...
- Implements the upstream GitHub awesome-copilot skill intent for `penpot-uiux-design`: Comprehensive guide for creating professional UI/UX designs in Penpot using MCP tools. Use this skill when: (1) Creating new UI/UX designs for web, mobile, or desktop applications, (2) Building design systems with compon
