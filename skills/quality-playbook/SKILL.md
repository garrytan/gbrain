...
triggers:
  - "quality-playbook"
  - "quality playbook"
  - "awesome copilot quality playbook"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `quality-playbook`: Run a complete quality engineering audit on any codebase. Derives behavioral requirements from the code, generates spec-traced functional tests, runs a three-pass code review with regression tests, executes a multi-model
