...
- Implements the upstream GitHub awesome-copilot skill intent for `update-markdown-file-index`: Update a markdown file section with an index/table of files from a specified folder.
