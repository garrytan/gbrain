...
- Implements the upstream GitHub awesome-copilot skill intent for `typespec-create-api-plugin`: Generate a TypeSpec API plugin with REST operations, authentication, and Adaptive Cards for Microsoft 365 Copilot
