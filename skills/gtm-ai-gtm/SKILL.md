...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-ai-gtm`: Go-to-market strategy for AI products. Use when positioning AI products, handling
