...
triggers:
  ...
  - "foundry hosted agent copilotkit"
  - "awesome copilot foundry hosted agent copilotkit"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `foundry-hosted-agent-copilotkit`: Ongoing development guidance for agentic web apps that pair a CopilotKit frontend with Microsoft Agent Framework agents on Azure AI Foundry hosted agents over the AG-UI protocol - add and gate agent tools, wire human-in-
