...
triggers:
  ...
  - "github actions hardening"
  - "awesome copilot github actions hardening"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `github-actions-hardening`: Security hardening reviewer for GitHub Actions workflow files (.github/workflows/*.yml). Reasons about the Actions threat model that pattern matchers and general code linters miss — untrusted-input script injection, priv
