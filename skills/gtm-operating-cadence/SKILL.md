...
triggers:
  ...
  - "gtm operating cadence"
  - "awesome copilot gtm operating cadence"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-operating-cadence`: Design meeting rhythms, metric reporting, quarterly planning, and decision-making velocity for scaling companies. Use when decisions are slow, planning is broken, the company is growing but alignment is worse, or leaders
