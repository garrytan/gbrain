...
- Implements the upstream GitHub awesome-copilot skill intent for `dataverse-python-production-code`: Generate production-ready Python code using Dataverse SDK with error handling, optimization, and best practices
