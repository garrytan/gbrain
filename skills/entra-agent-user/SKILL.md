...

{
  ...
  "userPrincipalName": "email-redacted.example",
...
- Implements the upstream GitHub awesome-copilot skill intent for `entra-agent-user`: Create Agent Users in Microsoft Entra ID from Agent Identities, enabling AI agents to act as digital workers with user identity capabilities in Microsoft 365 and Azure environments.
