...
- Implements the upstream GitHub awesome-copilot skill intent for `gen-specs-as-issues`: This workflow guides you through a systematic approach to identify missing features, prioritize them, and create detailed specifications for implementation.
