...
- Implements the upstream GitHub awesome-copilot skill intent for `mentoring-juniors`: Socratic mentoring for junior developers and AI newcomers. Guides through questions, never answers. Triggers:
