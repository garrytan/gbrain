...
- Implements the upstream GitHub awesome-copilot skill intent for `threat-model-analyst`: Full STRIDE-A threat model analysis and incremental update skill for repositories and systems. Supports two modes: (1) Single analysis — full STRIDE-A threat model of a repository, producing architecture overviews, DFD d
