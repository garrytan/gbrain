...
- Implements the upstream GitHub awesome-copilot skill intent for `mcp-copilot-studio-server-generator`: Generate a complete MCP server implementation optimized for Copilot Studio integration with proper schema constraints and streamable HTTP support
