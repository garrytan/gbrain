...
- Implements the upstream GitHub awesome-copilot skill intent for `devops-rollout-plan`: Generate comprehensive rollout plans with preflight checks, step-by-step deployment, verification signals, rollback procedures, and communication plans for infrastructure and application changes
