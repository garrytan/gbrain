...
triggers:
  ...
  - "qdrant monitoring setup"
  - "awesome copilot qdrant monitoring setup"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-monitoring-setup`: Guides Qdrant monitoring setup including Prometheus scraping, health probes, Hybrid Cloud metrics, alerting, and log centralization. Use when someone asks
