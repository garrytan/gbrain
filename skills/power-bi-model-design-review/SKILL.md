...
- Implements the upstream GitHub awesome-copilot skill intent for `power-bi-model-design-review`: Comprehensive Power BI data model design review prompt for evaluating model architecture, relationships, and optimization opportunities.
