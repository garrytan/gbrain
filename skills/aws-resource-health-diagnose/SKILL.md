...
triggers:
  ...
  - "aws resource health diagnose"
  - "awesome copilot aws resource health diagnose"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `aws-resource-health-diagnose`: Analyze AWS resource health, diagnose issues from CloudWatch logs and metrics, and create a remediation plan for identified problems.
