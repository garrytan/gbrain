...
triggers:
  ...
  - "qdrant sliding time window"
  - "awesome copilot qdrant sliding time window"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-sliding-time-window`: Guides sliding time window scaling in Qdrant. Use when someone asks
