...
triggers:
  ...
  - "gtm enterprise account planning"
  - "awesome copilot gtm enterprise account planning"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `gtm-enterprise-account-planning`: Strategic account planning and execution for enterprise deals. Use when planning complex sales cycles, managing multiple stakeholders, applying MEDDICC qualification, tracking deal health, or building mutual action plans
