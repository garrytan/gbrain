...
triggers:
  - "harness-engineering"
  - "harness engineering"
  - "awesome copilot harness engineering"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `harness-engineering`: Adopt repository-level harness engineering for coding agents. Use when a user wants to prevent repeated AI coding-agent mistakes by turning failures into durable instructions, drift checks, regression tests, failure memo
