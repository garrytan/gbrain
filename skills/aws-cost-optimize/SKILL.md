...
triggers:
  - "aws-cost-optimize"
  - "aws cost optimize"
  - "awesome copilot aws cost optimize"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `aws-cost-optimize`: Analyze AWS resources used in the app (IaC files and/or resources in a target account/region) and optimize costs - creating GitHub issues for identified optimizations.
