...
- Implements the upstream GitHub awesome-copilot skill intent for `csharp-mstest`: Get best practices for MSTest 3.x/4.x unit testing, including modern assertion APIs and data-driven tests
