...
triggers:
  - "publish-to-pages"
  - "publish to pages"
  - "awesome copilot publish to pages"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `publish-to-pages`: Publish presentations and web content to GitHub Pages. Converts PPTX, PDF, HTML, or Google Slides to a live GitHub Pages URL. Handles repo creation, file conversion, Pages enablement, and returns the live URL. Use when t
