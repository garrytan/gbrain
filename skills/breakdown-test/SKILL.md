...
- Implements the upstream GitHub awesome-copilot skill intent for `breakdown-test`: Test Planning and Quality Assurance prompt that generates comprehensive test strategies, task breakdowns, and quality validation plans for GitHub projects.
