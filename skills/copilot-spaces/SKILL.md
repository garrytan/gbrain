...
- Implements the upstream GitHub awesome-copilot skill intent for `copilot-spaces`: Use Copilot Spaces to provide project-specific context to conversations. Use this skill when users mention a
