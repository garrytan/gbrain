...
triggers:
  - "acreadiness-policy"
  - "acreadiness policy"
  - "awesome copilot acreadiness policy"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `acreadiness-policy`: Help the user pick, write, or apply an AgentRC policy. Policies customise readiness scoring by disabling irrelevant checks, overriding impact/level, setting pass-rate thresholds, or chaining org baselines with team overr
