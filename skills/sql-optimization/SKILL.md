...
SELECT * FROM orders 
WHERE UPPER(customer_email) = 'email-redacted.example';

-- ✅ GOOD: Index-friendly WHERE clause
SELECT * FROM orders 
WHERE customer_email = 'email-redacted.example';
...
- Implements the upstream GitHub awesome-copilot skill intent for `sql-optimization`: Universal SQL performance optimization assistant for comprehensive query tuning, indexing strategies, and database performance analysis across all SQL databases (MySQL, PostgreSQL, SQL Server, Oracle). Provides execution
