...
triggers:
  ...
  - "arduino azure iot edge integration"
  - "awesome copilot arduino azure iot edge integration"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `arduino-azure-iot-edge-integration`: Design and implement Arduino integration with Azure IoT Hub and IoT Edge, including secure provisioning, resilient telemetry, command handling, and production guardrails.
