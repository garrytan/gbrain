...
triggers:
  ...
  - "efcore d2 db diagram"
  - "awesome copilot efcore d2 db diagram"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `efcore-d2-db-diagram`: Generate D2 database diagrams from Entity Framework Core models. USE FOR: EF Core database diagram, Entity Framework Core ERD, DbContext diagram, C# entity relationship diagram, PostgreSQL schema visualization, generate 
