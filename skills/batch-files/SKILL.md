...
- Implements the upstream GitHub awesome-copilot skill intent for `batch-files`: Expert-level Windows batch file (.bat/.cmd) skill for writing, debugging, and maintaining CMD scripts. Use when asked to
