...
- Implements the upstream GitHub awesome-copilot skill intent for `rust-mcp-server-generator`: Generate a complete Rust Model Context Protocol server project with tools, prompts, resources, and tests using the official rmcp SDK
