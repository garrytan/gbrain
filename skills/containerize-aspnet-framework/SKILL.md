...
- Implements the upstream GitHub awesome-copilot skill intent for `containerize-aspnet-framework`: Containerize an ASP.NET .NET Framework project by creating Dockerfile and .dockerfile files customized for the project.
