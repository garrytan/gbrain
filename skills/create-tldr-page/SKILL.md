...
- Implements the upstream GitHub awesome-copilot skill intent for `create-tldr-page`: Create a tldr page from documentation URLs and command examples, requiring both URL and command name.
