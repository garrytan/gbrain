...
triggers:
  ...
  - "draw io diagram generator"
  - "awesome copilot draw io diagram generator"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `draw-io-diagram-generator`: Use when creating, editing, or generating draw.io diagram files (.drawio, .drawio.svg, .drawio.png). Covers mxGraph XML authoring, shape libraries, style strings, flowcharts, system architecture, sequence diagrams, ER di
