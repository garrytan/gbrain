...
- Implements the upstream GitHub awesome-copilot skill intent for `review-and-refactor`: Review and refactor code in your project according to defined instructions
