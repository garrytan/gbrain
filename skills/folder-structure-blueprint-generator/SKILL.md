...
- Implements the upstream GitHub awesome-copilot skill intent for `folder-structure-blueprint-generator`: Comprehensive technology-agnostic prompt for analyzing and documenting project folder structures. Auto-detects project types (.NET, Java, React, Angular, Python, Node.js, Flutter), generates detailed blueprints with visu
