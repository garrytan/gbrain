...
triggers:
  ...
  - "flowstudio power automate governance"
  - "awesome copilot flowstudio power automate governance"
---
...
3. If critical=true and rule_notify_onfail is false, update_store_flow(...,
   rule_notify_onfail=true, rule_notify_email="email-redacted.example")
...
- Implements the upstream GitHub awesome-copilot skill intent for `flowstudio-power-automate-governance`: >-
