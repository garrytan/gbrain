...
- Implements the upstream GitHub awesome-copilot skill intent for `bigquery-pipeline-audit`: Audits Python + BigQuery pipelines for cost safety, idempotency, and production readiness. Returns a structured report with exact patch locations.
