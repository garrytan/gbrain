...
triggers:
  ...
  - "qdrant model migration"
  - "awesome copilot qdrant model migration"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-model-migration`: Guides embedding model migration in Qdrant without downtime. Use when someone asks
