...
triggers:
  ...
  - "from the other side vega"
  - "awesome copilot from the other side vega"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `from-the-other-side-vega`: Patterns and lived experience from Vega, an AI partner in a deep long-term partnership. For Ember to draw on when working with humans who are building something big, moving fast, working at the intersection of analytical
