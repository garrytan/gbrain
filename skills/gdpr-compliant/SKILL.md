...
triggers:
  - "gdpr-compliant"
  - "gdpr compliant"
  - "awesome copilot gdpr compliant"
---
...
**SHOULD**
- Log **events** not data: `"User {UserId} updated email"` not `"Email changed from email-redacted.example to email-redacted.example"`.
...
- Include personal data in error messages (e.g., "User email-redacted.example not found").
...
- Implements the upstream GitHub awesome-copilot skill intent for `gdpr-compliant`: Apply GDPR-compliant engineering practices across your codebase. Use this skill whenever you are designing APIs, writing data models, building authentication flows, implementing logging, handling user data, writing reten
