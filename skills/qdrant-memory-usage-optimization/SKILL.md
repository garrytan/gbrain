...
triggers:
  ...
  - "qdrant memory usage optimization"
  - "awesome copilot qdrant memory usage optimization"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-memory-usage-optimization`: Diagnoses and reduces Qdrant memory usage. Use when someone reports
