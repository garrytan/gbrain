...
- Implements the upstream GitHub awesome-copilot skill intent for `phoenix-tracing`: OpenInference semantic conventions and instrumentation for Phoenix AI observability. Use when implementing LLM tracing, creating custom spans, or deploying to production.
