...
- Implements the upstream GitHub awesome-copilot skill intent for `legacy-circuit-mockups`: Generate breadboard circuit mockups and visual diagrams using HTML5 Canvas drawing techniques. Use when asked to create circuit layouts, visualize electronic component placements, draw breadboard diagrams, mockup 6502 bu
