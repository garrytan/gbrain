...
triggers:
  ...
  - "optimize simplicite logs"
  - "awesome copilot optimize simplicite logs"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `optimize-simplicite-logs`: capability to parse Simplicité logs from a raw `.txt` file, filter fields to reduce noise, and output the result as structured JSON.
