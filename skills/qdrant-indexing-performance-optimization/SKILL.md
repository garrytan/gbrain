...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-indexing-performance-optimization`: Diagnoses and fixes slow Qdrant indexing and data ingestion. Use when someone reports
