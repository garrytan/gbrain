...
triggers:
  ...
  - "slang shader engineer"
  - "awesome copilot slang shader engineer"
---
# Slang Shader Expert
...
- Implements the upstream GitHub awesome-copilot skill intent for `slang-shader-engineer`: Use when working with Slang shaders, shader modules, HLSL-compatible GPU code, graphics pipelines, compute shaders, tessellation, ray tracing, parameter blocks, generics, interfaces, capabilities, cross-compilation, shad
