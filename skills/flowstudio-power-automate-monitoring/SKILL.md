...
[
  {
    ...
    "displayName": "email-redacted.example",
...
2. Optionally set rule_notify_onfail=true, rule_notify_email="email-redacted.example"
...
- Implements the upstream GitHub awesome-copilot skill intent for `flowstudio-power-automate-monitoring`: >-
