...
1. **Schema verify** — schema migrations v32 (takes + synthesis_evidence)
   and v33 (access_tokens.permissions JSONB) ran; tables are present.
   (v31 was claimed by v0.25's eval_capture_tables before v0.28 landed.)
