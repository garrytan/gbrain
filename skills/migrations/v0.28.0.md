...
1. **Schema verify** — schema migrations v35 (takes + synthesis_evidence)
   and v36 (access_tokens.permissions JSONB) ran; tables are present.
   (v31 was claimed by v0.25's eval_capture_tables, v32+v33 by v0.26's
   OAuth + admin dashboard, and v34 by v0.26.5's destructive-guard columns
   before v0.28 landed.)
