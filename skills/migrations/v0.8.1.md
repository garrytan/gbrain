...
version: 0.8.1
feature_pitch:
  headline: "Your Cortex workspace skills learned from production"
...
echo '{"version":"0.8.1","ts":"'$(date -u +%Y-%m-%dT%H:%M:%SZ)'","status":"complete"}' >> ~/.cortex/migrations/completed.jsonl
```
