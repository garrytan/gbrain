...
triggers:
  - "unit-test-vue-pinia"
  - "unit test vue pinia"
  - "awesome copilot unit test vue pinia"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `unit-test-vue-pinia`: Write and review unit tests for Vue 3 + TypeScript + Vitest + Pinia codebases. Use when creating or updating tests for components, composables, and stores; mocking Pinia with createTestingPinia; applying Vue Test Utils p
