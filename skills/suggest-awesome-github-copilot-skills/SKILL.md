...
- Implements the upstream GitHub awesome-copilot skill intent for `suggest-awesome-github-copilot-skills`: Suggest relevant GitHub Copilot skills from the awesome-copilot repository based on current repository context and chat history, avoiding duplicates with existing skills in this repository, and identifying outdated skill
