...
triggers:
  - "foundry-agent-sync"
  - "foundry agent sync"
  - "awesome copilot foundry agent sync"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `foundry-agent-sync`: Create and synchronize prompt-based AI agents directly within Azure AI Foundry via REST API, from a local JSON manifest. Unlike scaffolding skills that only generate local code, this skill registers agents in the Foundry
