...
triggers:
  ...
  - "qdrant minimize latency"
  - "awesome copilot qdrant minimize latency"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `qdrant-minimize-latency`: Guides Qdrant query latency optimization. Use when someone asks
