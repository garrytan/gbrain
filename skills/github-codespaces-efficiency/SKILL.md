...
triggers:
  ...
  - "github codespaces efficiency"
  - "awesome copilot github codespaces efficiency"
---
...
- Implements the upstream GitHub awesome-copilot skill intent for `github-codespaces-efficiency`: Audit and improve GitHub Codespaces efficiency. Use this skill when a user wants faster Codespaces startup, lower Codespaces spend, slim devcontainers, right-size machines, tune idle timeout, or scope prebuilds to branch
