...
- Implements the upstream GitHub awesome-copilot skill intent for `breakdown-feature-prd`: Prompt for creating Product Requirements Documents (PRDs) for new features, based on an Epic.
