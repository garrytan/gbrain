...
- Implements the upstream GitHub awesome-copilot skill intent for `acquire-codebase-knowledge`: Use this skill when the user explicitly asks to map, document, or onboard into an existing codebase. Trigger for prompts like
