...
Use these test credentials: username: email-redacted.example, password: TestPass123
"
...
- Implements the upstream GitHub awesome-copilot skill intent for `scoutqa-test`: This skill should be used when the user asks to
