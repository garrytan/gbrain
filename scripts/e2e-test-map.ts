...
export const E2E_TEST_MAP: Record<string, string[]> = {
  "src/core/memory-cues/**": ["test/e2e/memory-cues-parity.test.ts", "test/e2e/memory-cues-read-policy-postgres.test.ts"],
  "src/core/minions/handlers/memory-cues-build.ts": ["test/e2e/memory-cues-parity.test.ts"],
  ...
  "src/core/ops/**": ["test/e2e/engine-content-privacy.test.ts", "test/e2e/remote-privacy-journeys.test.ts", "test/e2e/read-enrichment-privacy.test.ts", "test/e2e/legacy-chunk-privacy.test.ts", "test/e2e/chunk-canonical-text-privacy.test.ts", "test/e2e/put-page-persistence-postgres.test.ts", "test/e2e/deep-research-source-id.test.ts", "test/e2e/deep-research-http.test.ts", "test/e2e/memory-cues-parity.test.ts"],
  ...
  "src/core/search/**": [
    "test/e2e/memory-cues-parity.test.ts",
    "test/e2e/memory-cues-read-policy-postgres.test.ts",
