...
/**
 * v0.40.7.1: look up the `reranker.default_timeout_ms` declared by the
 * resolved reranker model's recipe touchpoint. Returns undefined when:
...
export function resolveSearchMode(input: ResolveSearchModeInput): ResolvedSearchKnobs {
  ...
  // v0.40.7.1: `reranker_timeout_ms` resolution slots the resolved recipe's
