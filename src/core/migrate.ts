...
export const MIGRATIONS: Migration[] = [
  ...
  {
    // Renumbered 117 -> 120 at rebase: master's v0.42.43+v0.42.44+v0.42.51 wave
    // claimed v117 (context_volunteer_events_table), v118 (page_generation_clock_sequence_swap),
    // and v119 (op_checkpoints_completed_keys_array_check) first.
    version: 120,
    name: 'sources_config_fingerprint',
    // #2157 follow-on: the "Already up to date" gate at sync.ts:1430 honors
