 ...
 * (`WHERE embedding IS NULL AND expired_at IS NULL AND NOT (source = ANY
 * (AUDIT_ROW_SOURCES))` — #4875: audit rows are not embeddable), narrowed by
 * source.
 */
