...
export function createMemoryMutationLedgerOperations(
  ...
  const list_memory_mutation_events: Operation = {
    ...
    params: {
      ...
      actor: { type: 'string' },
      operation: { type: 'string', enum: [...MEMORY_MUTATION_OPERATION_NAMES], compactEnum: false },
      target_kind: { type: 'string', enum: [...MEMORY_MUTATION_TARGET_KINDS], compactEnum: false },
      target_id: { type: 'string' },
      scope_id: { type: 'string' },
      result: { type: 'string', enum: [...MEMORY_MUTATION_RESULTS], compactEnum: false },
  ...
  const record_memory_mutation_event: Operation = {
    ...
    params: {
      ...
      operation: { type: 'string', required: true, enum: [...MEMORY_MUTATION_OPERATION_NAMES], compactEnum: false },
      target_kind: { type: 'string', required: true, enum: [...MEMORY_MUTATION_TARGET_KINDS], compactEnum: false },
      ...
      result: { type: 'string', required: true, enum: [...MEMORY_MUTATION_RESULTS], compactEnum: false },
