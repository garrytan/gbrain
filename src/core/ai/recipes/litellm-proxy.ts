...
export const litellmProxy: Recipe = {
  ...
  setup_hint: 'Run LiteLLM (https://docs.litellm.ai) in front of any provider; set LITELLM_BASE_URL, then pass --embedding-model litellm:<model> --embedding-dimensions <N> and/or --chat-model litellm:<model>.',
};
