 ...
 *
 * Models served through the OpenAI-compatible shape:
 *   deepseek-v4-flash, deepseek-v4-pro, mimo-v2.5, mimo-v2.5-pro,
 *   glm-5.2, glm-5.1, kimi-k2.7-code, kimi-k2.6, qwen3.5-plus
 *
 * Models served through the Anthropic Messages shape (NOT usable via this
 * recipe): minimax-m3/m2.7/m2.5, qwen3.7-max/plus, qwen3.6-plus.
 *
