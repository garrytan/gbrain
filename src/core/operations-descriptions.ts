...
export const LIST_PAGES_DESCRIPTION =
  ...
  "Default 50 rows; remote requests are capped at 100 (the thin-client CLI " +
  "paginates bare lists and explicit larger limits). A result with exactly `limit` rows may be truncated. " +
