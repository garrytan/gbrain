...
export class PostgresEngine implements BrainEngine {
  ...
  /**
   * v0.33.0 — batched per-page active-takes fetch (P1). One round-trip
  ...
  /**
   * v0.33.0 — persist a contradiction-probe run row (M5). Idempotent on
  ...
  /**
   * v0.33.0 — load probe runs from the last N days, newest first (M5).
  ...
  /**
   * v0.33.0 — judge cache lookup (P2). Returns verdict JSON for a non-
  ...
  /**
   * v0.33.0 — judge cache upsert. ON CONFLICT DO UPDATE refreshes verdict +
  ...
  /** v0.33.0 — periodic sweep of expired cache rows. */
