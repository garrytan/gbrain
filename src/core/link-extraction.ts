...
// running past it.
// 2026-09-08 bump: the page-role prior no longer applies to links inside
// Timeline / See-also and the other machine-written list sections
// (rolePriorSuppressedRanges), so pre-fix extractions carrying prior-typed
// works_at/advises edges from those sections must re-run to demote them
// to 'mentions'.
export const LINK_EXTRACTOR_VERSION_TS = '2026-09-08T00:00:00Z';
