...
const EMBEDDING_MODEL = process.env.GBRAIN_EMBED_MODEL || process.env.OPENAI_EMBED_MODEL || 'text-embedding-3-large';
const EMBEDDING_DIMENSIONS = parseInt(process.env.GBRAIN_EMBED_DIMENSIONS || process.env.OPENAI_EMBED_DIMENSIONS || '1536', 10);
