...
import { LONGMEMEVAL_QA_DIMENSIONS } from '../cross-modal-eval/runner.ts';
 ...
 */
/** Back-compatible name for callers that imported the probe-specific rubric. */
export const PROBE_QA_DIMENSIONS = LONGMEMEVAL_QA_DIMENSIONS;
