...
CREATE TABLE IF NOT EXISTS links (
  ...
  --
  -- v0.36.0 (TIM-28) — widen to record which wikilink-fallback resolver
  -- pinned each edge: 'path' (exact slug match), 'alias' (frontmatter
  -- aliases hit), 'title' (H1 heading hit), 'basename' (filename
  -- last-segment hit).
