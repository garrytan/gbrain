...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_DZm8MEVM_js from '../admin/dist/assets/index-DZm8MEVM.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-DZm8MEVM.js": { path: A_1_assets_index_DZm8MEVM_js as unknown as string, mime: "application/javascript; charset=utf-8" },
