...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_Nckuov7A_js from '../admin/dist/assets/index-Nckuov7A.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-Nckuov7A.js": { path: A_1_assets_index_Nckuov7A_js as unknown as string, mime: "application/javascript; charset=utf-8" },
