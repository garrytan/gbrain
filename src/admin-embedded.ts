...
// Source: admin/dist/ at 2026-09-09.
//
...
import A_0_assets_index_B_n2EELS_js from '../admin/dist/assets/index-B_n2EELS.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CCwQ2g0L_css from '../admin/dist/assets/index-CCwQ2g0L.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-B_n2EELS.js": { path: A_0_assets_index_B_n2EELS_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-CCwQ2g0L.css": { path: A_1_assets_index_CCwQ2g0L_css as unknown as string, mime: "text/css; charset=utf-8" },
