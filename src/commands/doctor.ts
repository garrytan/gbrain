...
/** env var > DB config key > hard default (pace-mode precedence). */
 ...
 * embed stale → search stale). Env/config overrides (env wins, #2505):
 *   - GBRAIN_CYCLE_FRESHNESS_WARN_HOURS (default 6)
 *   - GBRAIN_CYCLE_FRESHNESS_FAIL_HOURS (default 24)
 *   - GBRAIN_CYCLE_FRESHNESS_SOURCE_ALLOWLIST / _IGNORELIST
