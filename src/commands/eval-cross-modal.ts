...
FLAGS:
  ...
  --slot-a-model <id>      Override default '${DEFAULT_SLOTS[0]!.model}'.
  --slot-b-model <id>      Override default '${DEFAULT_SLOTS[1]!.model}'.
  --slot-c-model <id>      Override default '${DEFAULT_SLOTS[2]!.model}'.
