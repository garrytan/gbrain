...
const PER_TASK_KEYS: PerTaskModelRoute[] = [
  ...
  { key: 'models.extract_atoms',            tier: 'utility',   description: 'Atom extraction', deprecatedConfigKey: 'models.dream.extract_atoms' },
  { key: 'models.synthesize_concepts',      tier: 'reasoning', description: 'Concept narrative synthesis' },
  { key: 'models.consolidate',              tier: 'reasoning', description: 'Fact-cluster consolidation into takes' },
  { key: 'models.propose_takes',            tier: 'reasoning', description: 'Gradeable-take proposal extraction' },
