...
const PER_TASK_KEYS: Array<{ key: string; tier: ModelTier; description: string }> = [
  ...
  { key: 'models.tier.propose_takes',       tier: 'reasoning', description: 'Dream cycle take proposal extractor' },
  { key: 'models.tier.grade_takes',         tier: 'reasoning', description: 'Dream cycle take grading judge' },
  { key: 'models.tier.calibration_profile', tier: 'reasoning', description: 'Dream cycle calibration profile generation' },
