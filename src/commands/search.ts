...
const KNOB_DESCRIPTIONS: Record<keyof ModeBundle, string> = {
  ...
  autocut_min_top_score: 'Autocut weak-top floor: min top rerank score to trust the cliff (0..1, 0.50 default; 0 disables; below it autocut no-ops to preserve recall; forced to 0 on raw-logit rerankers — llama-server/Qwen3 — whose scores are not [0,1])',
