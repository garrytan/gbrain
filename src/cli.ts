...
const CLI_ONLY = new Set(['agent', 'apply-migrations', 'autopilot', 'call', 'check-backlinks', 'check-resolvable', 'check-update', 'code-callees', 'code-callers', 'code-def', 'code-refs', 'config', 'doctor', 'dream', 'embed', 'eval', 'export', 'extract', 'features', 'files', 'graph-query', 'import', 'init', 'integrations', 'integrity', 'jobs', 'lint', 'migrate', 'orphans', 'post-upgrade', 'publish', 'reindex-code', 'repair-jsonb', 'report', 'repos', 'resolvers', 'routing-eval', 'serve', 'skillify', 'skillpack', 'skillpack-check', 'smoke-test', 'sources', 'sync', 'upgrade']);
