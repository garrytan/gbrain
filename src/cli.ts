...
async function handleCliOnly(command: string, args: string[]) {
  ...
  // Office-ingest sidecar management (setup-docling / start). No brain needed.
  if (command === 'ingest') {
