...
*(Answer truncated — 4269 chars total)*
...
| 4 | Add a one-liner guard in `main.js` to push a dummy item if input is empty—prevents free runs (per Apify bes

*(Answer truncated — 4045 chars total)*
