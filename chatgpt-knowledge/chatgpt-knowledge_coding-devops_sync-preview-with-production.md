...
*(Answer truncated — 6708 chars total)*
...
on:
  workflow_run:
    workflows: ["promote-preview-to-produ
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <UserProfile
        routing="path"
        path="/settings/account"
        // Local appearance overrides specifically to kill Clerk's internal nav/si

*(Answer truncated — 6696 chars total)*
...
If you want to keep preview scans for visibility, leave your original triggers—but **do not** make “Code scanning results” required on 
