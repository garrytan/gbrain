...
### d. Next.js  
1. Base your repo on Vercel’s **

*(Answer truncated — 4849 chars total)*
...
5. **Branding Gate**
   * Wrap `components/BrandingBadge.tsx` export with:
     ...
     export default function BrandingBadge() {
       return (
         <Gate plan="free">
           <div className="text-xs opacity-60">Made

*(Answer truncated — 4433 chars total)*
