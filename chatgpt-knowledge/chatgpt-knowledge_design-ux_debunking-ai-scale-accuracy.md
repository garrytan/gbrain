...
- If Humane’s scale still relies on foot-based BIA, they are still subject to all the same error sources above. Unless they do something like **multi-site BIA** (both feet + both han
