...
5. Import into Figma varia

*(Answer truncated — 4260 chars total)*
...
- Dark mode is not inverted — it’s carefully t

*(Answer truncated — 3706 chars total)*
...
*(Answer truncated — 3480 chars total)*
