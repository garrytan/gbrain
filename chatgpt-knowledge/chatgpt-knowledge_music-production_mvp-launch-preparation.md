...
{'content_type': 'audio_transcription', 'decoding_id': None, 'direction': 'in', 'text': "I think we just a big thing that really helped that I just did is adding the pre-commit hooks for tests and linting. I'm getting a lot less issues where AI branches or AI agents are pushing code that is 
