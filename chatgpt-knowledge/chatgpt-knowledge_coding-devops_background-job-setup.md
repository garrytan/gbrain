...
*(Answer truncated — 6035 chars total)*
...
- **You do *not* need a `processing_status` field or a jobs table** if you go with Option 1 (on-the-fly optimization) or Option 2 (synchronous convers
...
- Conversion sometimes takes long enough to make the upload request feel bad (>2–3 seconds), 
...
2. Sharp conversions sometimes take t
