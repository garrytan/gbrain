...
⚡ Recommendation: Ship **Phase 1–2 in one sprint** (CSV import + simple management), then prioritize **Phase 4 (sign
...
👉 Right now, light mode is functional but **sterile**. With 
...
*(Answer truncated — 5806 chars total)*
...
> ```
>  
> Please ignore entries that aren’t real artists (e.g., ‘music-maker’, ‘pop-star’, 
...
*(Answer truncated — 3907 chars total)*
...
3) **Classify**:
   - If URL path starts with any MUSIC patterns 

*(Answer truncated — 7230 chars total)*
...
*(Answer truncated — 3058 chars total)*
...
Jobs should be able to run simulatanouesly without conflicts so our AI needs to plan and break them up and open them in linear and tag
...
7) **Public profile “Tip with Venmo” button**  
   - Add CTA to public pr

*(Answer truncated — 7790 chars total)*
