...
at ReactiveEffect.run (http://localhost:3000/_nuxt/node_modu
...
Error fetching user: Invalid API key
 ...
 ERROR  [unhandledRejection] Cannot read properties of undefined (reading 'value')
    ...
    at renderVNode (node_modules/.pnpm
...
- **Safeguarding useAuth:**  
  We check whether `useAuth` is defined as a function. If not, 

*(Answer truncated — 3746 chars total)*
