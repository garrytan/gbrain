...
Also check auxiliary models. Hermes says auxiliary tasks can fall back to the main model, and tasks like title generation, compression, approva
...
GBrain can also increase spend if Hermes loads too much of it. GBrain’s docs reference large deployments with **40+ skills** and **20+ cron jobs**; if your setup has automated jobs, enrichers, or collectors running through Hermes/OpenRouter, those can silently create daily burn. cit

*(Answer truncated — 4214 chars total)*
