...
The public `/launch` page discloses too much: adaptive CTAs, email/SMS notifications, streaming preference memory, AI assistant, Spotify Canvas generator, Apple Lyrics formatter, impersonation alerts, fan scoring, source attributi

*(Answer truncated — 8442 chars total)*
...
- Main goal: streams, presaves, email/SMS capture, shows,

*(Answer truncated — 8039 chars total)*
