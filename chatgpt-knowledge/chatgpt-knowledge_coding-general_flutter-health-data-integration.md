...
This approach ensures that whenever the `isMetric` flag is toggled, the `Consumer<UserModel>` widget will rebuild its child wi

*(Answer truncated — 3074 chars total)*
