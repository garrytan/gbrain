...
- **Full E2E** (staging & prod gate):  
  All critical + edge cases, error handling, permission states, slow paths, cross-browser smoke, migrations, a

*(Answer truncated — 4374 chars total)*
