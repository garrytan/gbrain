...
module.exports = {
  ...
  plugins: [
    new CopyPlugin({
      patterns: [{ from: "static" }, { from: "src/assets/css", to: "src/assets/css" }, { from: "src/assets/icons", to: "src/assets/icons" }, { from: "src/assets/images", to: "src/assets/images" }, { from: "src/popup.html", to: "src/popup.html" }, { from: "src/gmailSidebar.html"
