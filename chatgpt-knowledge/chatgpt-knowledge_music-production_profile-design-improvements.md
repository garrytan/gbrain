...
- **Referrer nudge:** If the visitor came from TikTok, allow TikTok to move up **one slot** at most (implemented above). Keeps familiarity without wrecking global consist

*(Answer truncated — 3461 chars total)*
...
If you want, I can mock you a **visual wireframe** of the “Tip + Bell inline + referrer-aware sorting” so you can see how it would feel

*(Answer truncated — 3125 chars total)*
...
## **7. Typography**
- **Current:** Solid, but heavy contrast
