...
- **product_entity["turn0product16","Thermal Perforated Ticket Paper (Heat-Sensitive)"]**: Heat-sensitive (thermal) paper is great for smudge-proofness and harder to copy (since images formed by heat). 
