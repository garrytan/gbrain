...
1. **Keep CI fast** – Split lanes: lint/static (≤1 min), tests (p

*(Answer truncated — 3587 chars total)*
...
*(Answer truncated — 4445 chars total)*
...
*(Answer truncated — 3810 chars total)*
...
With those tweaks the pipelines will line up with the “rock-solid, reviewer-
...
3. **Nightly perf/leak workflow** for web (you alrea
...
Once those four core steps are done, TestFlight should “just 
...
In your Fastlane `beta` lan

*(Answer truncated — 7165 chars total)*
...
| **Store review automation** | `fastlane deliver --s

*(Answer truncated — 3606 chars total)*
...
```yaml
- uses: slackapi/slack-git

*(Answer truncated — 3988 chars total)*
...
Do the first **four** bullet fixes and the pipeline will fully align with the Rapid → nightly Confi
