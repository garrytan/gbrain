<!-- mbrain-agent-rules-version: 0.5.9 -->
...
Inspect, verify, promote, reject, or supersede candidates; record grounded checks
with `verify_memory_candidate_entry` before promotion, and block refuted
candidates.
