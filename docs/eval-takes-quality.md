...
| `--models a,b,c` | `openai:gpt-5.6-terra,anthropic:claude-opus-4-7,google:gemini-3.6-flash` | Comma-separated panel. |
...
```json
{
  ...
  "models": ["openai:gpt-5.6-terra", "anthropic:claude-opus-4-7", "google:gemini-3.6-flash"],
  "cycles_run": 3,
