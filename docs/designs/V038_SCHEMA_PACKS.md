...
> Status: DESIGN.
> This page is the v0.38 CEO plan. Current schema-pack architecture and
> authoring guidance live in [`../architecture/schema-packs.md`](../architecture/schema-packs.md),
> [`../schema-author-tutorial.md`](../schema-author-tutorial.md), and
> [`../what-schemas-unlock.md`](../what-schemas-unlock.md).
