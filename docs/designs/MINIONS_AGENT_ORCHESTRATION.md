...
> Status: DESIGN.
> This page is a CEO-plan/design record, not current operator guidance. Current
> Minions operation lives in [`../guides/minions-deployment.md`](../guides/minions-deployment.md),
> [`../guides/minions-fix.md`](../guides/minions-fix.md), and
