...
Recipe ships with `nomic-embed-text` (768d, recommended), `mxbai-embed-large` (1024d), `bge-m3` (1024d), `all-minilm` (384d). `gbrain providers test --model ollama:nomic-embed-text` smoke-tests the local install.
