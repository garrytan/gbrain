...
conversation_id: 69ee7bec-463c-83e8-a879-7c15036c9941
message_count: 7
tags: [chatgpt, import, code]
---
# NVIDIA Free API Models

> Conversation ID: 69ee7bec-463c-83e8-a879-7c15036c9941
> Created: 2026-04-26T20:56:13Z
> Updated: 2026-04-26T21:40:11Z
> Messages: 7
...
resp = client.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "You are ARAMIS, an agentic operating model for production-focused startup execution."},
        {"role": "user", "content": "Review this task list and choose the highest-leverage next action."},
    ],
    temperature=0.2,
    max_tokens=2000,
)
...
For a **free NVIDIA-hosted ARAMIS main model**, pick:

**`deepseek-ai/deepseek-v4-pro`**

Use:

**`deepseek-ai/deepseek-v4-flash`** for cheap/fast worker agents.

Keep NVIDIA behind a provider abstraction with fallbacks, because free access is development/trial-oriented and rate limits/availability can move.
