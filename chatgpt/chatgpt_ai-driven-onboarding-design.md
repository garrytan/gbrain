...
Can you dive in even further and map out exactly:
- mom test questions and everything
- objection handling and stuff
and just lay out exactly what you think for Jovie? Look at the wider landscape of music and all the products that are competing with us or adjacent to us. Think of what users are saying on the internet about them and their complaints and stuff, and how all that can inform our objection handling and everything.And then what is the path for building this? What would you suggest as the system that powers it? 
