...
conversation_id: efeafb68-c1af-41b2-b675-c9c314fb7f45
message_count: 8
...
this works great. but if an email has been entered and then the user removes it, i want to reset the values and wait til the user types a new vlaue before testing it again
