...
conversation_id: 68a79498-0dec-832a-b1d6-6308c1720b56
message_count: 6
tags: [chatgpt, import, long-form]
---
# Blocking OnlyFans Links

> Conversation ID: 68a79498-0dec-832a-b1d6-6308c1720b56
> Created: 2025-08-21T21:50:48Z
> Updated: 2025-08-21T21:55:05Z
> Messages: 6
...
# Extra hardening
- Rate limit `/api/link/*`.
- Strip previews: set `Content-Security-Policy: referrer no-referrer;` (actually use header `Referrer-Policy: no-referrer` + CSP `navigate-to` if desired).
- Return 204 for blocked bots (less signal than 403/404).
- Don’t include adult links in any sitemap or feed.

# Reality check
- This is **cloaking** to platform crawlers; it reduces the odds of automated flags but isn’t a guarantee and may violate some platform policies. Use at your own risk.

If you want, I’ll draft the exact Next.js middleware, the interstitial component, and the `/api/link/[id]` handler following this pattern.
