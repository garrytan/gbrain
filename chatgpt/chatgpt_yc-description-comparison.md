...
conversation_id: 69e81654-8b30-83e8-98ff-c16a554f798d
message_count: 40
tags: [chatgpt, import, code, long-form]
---
# YC Description Comparison

> Conversation ID: 69e81654-8b30-83e8-98ff-c16a554f798d
> Created: 2026-04-22T00:29:09Z
> Updated: 2026-04-22T20:27:02Z
> Messages: 40
...
> It handles the repetitive operational work between finishing a song and launching it everywhere.

## Slide 4: practical example

Use a named person. Seibel likes user paths because they make the product visible. citeturn378034view0

> **Maya is a house DJ in Brooklyn.**  
> She connects her Spotify page and uploads her next track to Jovie.  
> In 60 seconds, Jovie creates her artist profile, release page, smart links, and matched metadata across 27 music platforms.  
> She gets the release infrastructure of a label without hiring a label team.

This is the clearest example.

## Slide 5: unique insight

> **Music release work looks creative from the outside. Most of it is operations.**  
> The same release assets, metadata, links, profiles, and platform rules get rebuilt over and over.  
> I have done this manually for 15 years. Jovie turns that workflow into software.

This is likely the strongest “why you” / “why now” angle.

## Slide 6: why now

> **AI can now do the work that used to require a release coordinator.**  
> It can read platform rules, generate release assets, check metadata, match profiles, and complete repeatable workflows across services.

I would keep this high-level unless the deck has a product/tech slide.

## Slide 7: positioning

Possible positioning lines:

> **Jovie is Rippling for music release ops.**

> **Jovie is an AI ops team for independent artists and labels.**

> **Jovie gives every artist the release infrastructure of a label.**

Best one for investors:

> **Jovie gives every artist the release infrastructure of a label.**

Best one for YC:

> **Jovie automates release ops for artists and labels.**

## Slide 8: team

> **Founder-market fit**  
> Tim has spent 15 years building music release workflows manually. Jovie is the software version of that operating system.

If you want it sharper:

> **I am building the tool I needed for 15 years.**

## The full 2-minute pitch draft

> **Jovie helps artists and labels release music faster.**  
> Our AI agent automates the release work I spent 15 years doing manually: artist profiles, release pages, smart links, metadata, assets, and platform setup.  
>   
> For example, a house DJ in Brooklyn can connect her Spotify page, upload a track, and Jovie creates a polished artist profile, release page, smart links, and matched metadata across 27 music platforms in 60 seconds.  
>   
> The insight is that music release work looks creative from the outside, but most of it is repetitive operations. Every artist and label has to rebuild the same release infrastructure over and over. Jovie turns that manual workflow into software.  
>   
> We start with independent artists and small labels, then become the release operating system for the music industry.

## The tightest deck language

I’d make the deck say this:

> **Jovie helps artists and labels release music faster.**  
> **Artists upload once. Jovie creates the profiles, release pages, smart links, metadata, and platform-ready assets they need to launch everywhere.**

Then the example slide:

> **Example:**  
> A house DJ in Brooklyn connects her Spotify page and uploads a track.  
> 60 seconds later, she has a polished release page, artist profile, smart links, and matched metadata across 27 music platforms.

Then the insight slide:

> **The insight:**  
> Music release work is mostly repeatable ops.  
> I spent 15 years doing it manually.  
> Jovie turns that workflow into an AI agent.

My recommended exact phrasing for the deck:

> **Jovie helps artists and labels release music faster.**  
> **Our AI agent turns one upload into the release pages, profiles, links, metadata, and platform-ready assets artists need to launch everywhere.**

That is the cleanest Seibel-style version.
...
> A house DJ in Brooklyn connects her Spotify profile. Jovie finds her matching artist pages across 27 platforms. When her next song appears on any platform, Jovie detects the ISRC and automatically creates the release page, updates her profile, checks the metadata, generates smart links, and notifies the right people.

I’d define **PANS** on first use in the deck unless every investor seeing it already knows the acronym.
...
The next slide shows an up-and-to-the-right chart with clear peaks, but the peaks are monthly, every four weeks there’s a release. Even as it dips, there’s a new release before hitting baseline, so the line keeps climbing. It’s like up and to the right stairs. It would say: Jovie helps them look like this. The front of it reads: Jovie helps artisan labels release music faster. You can get everything you need from just that, I think.
...
People don’t know what an ISRC code is, so I should make that clear on the slide. Include wording that says ISRC appears on music platforms, on music platforms, or on 27 music platforms, or whatever it is. Just make it clear what that is, and use sentence case. There’s a lot of inconsistent capitalization here, so I’d go sentence case on “the distributor delivers,” etc.

Please add a team slide. It should communicate that Tim White is the founder and Daniel Kang is an advisor. It should also convey that Tim White spent 15 years in the music industry manually building the workflows jovie automates to drive 90M streams. 
That's it.
...
Use a clean three-row table:
75k artists × $49/mo = $44M ARR
10k labels × $299/mo = $36M ARR
2k pro label teams × $999/mo = $24M ARR
Total = $104M ARR
Keep copy minimal:
“Three customer tiers get Jovie past $100M ARR.”
Do not add TAM fluff.

7. Team
Use the provided image of Tim White at Universal Music Group as subtle social proof. It should feel background / secondary, not like a hero photo.
Copy:
“Tim White”
“Founder”
“15 years in music.”
“Built the manual release workflows Jovie automates to drive 90M streams.”
Keep Daniel off this slide.

8. Ask
Copy:
“Raising $2M on a post-money SAFE.”
Keep the slide extremely clean.
Optional subline:
“To build the AI release ops layer for artists and labels.”

Appendix A: Not distribution
This is an answer slide for people who ask if Jovie is a distributor.
Use a simple two-column comparison:
“Distribution”
“Gets music onto platforms.”
Example: DistroKid, TuneCore, CD Baby.

“Jovie”
“Automates what happens after music appears.”
Examples: profile matching, ISRC detection, release pages, smart links, fan notifications, launch workflows.

Appendix B: Go-to-market
Copy:
“We send artists a pre-built Jovie profile.”
“They are already paying for 2+ tools Jovie replaces.”
“X% of cold outreach targets claim their profile.”
“We have identified Z qualified leads.”
Leave X% and Z as placeholders unless real numbers are provided.
...
Do not make Jovie sound like a distributor.
Do not say artists upload music to Jovie.
Do not say Jovie delivers music to DSPs.
Use “music platforms” instead of “DSPs” unless DSP is defined.
Use “appears on music platforms” for releases.
Use “detects ISRCs” only with a plain-English explanation.
Do not overdesign. The slides should feel expensive because they are simple.

Output:
Deliver an editable PowerPoint deck.
Also export a PNG preview of each slide and a single montage preview.
```
