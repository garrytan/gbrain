...
conversation_id: 6a0d3722-c30c-83e8-8188-4f72b3900511
message_count: 6
tags: [chatgpt, import, code, long-form]
---
# AI Tool Reasoning Task

> Conversation ID: 6a0d3722-c30c-83e8-8188-4f72b3900511
> Created: 2026-05-20T04:22:59Z
> Updated: 2026-05-20T04:51:34Z
> Messages: 6
...
This tests whether the tool can do **business reasoning**, not just content generation. A strong answer should connect catalog data, fan behavior, release timing, and team constraints into a ranked plan.

### Grading rubric

| Area | What good looks like |
|---|---|
| Prioritization | Picks one clear primary strategy instead of listing everything |
| Reasoning | Explains why the chosen track, audience, and campaign type matter |
| Constraint handling | Respects 18-day release window, $750 budget, and 5 hours/week |
| Segmentation | Treats email, SMS, Spotify, Instagram, TikTok, and geo markets differently |
| Automation logic | Identifies what Jovie should trigger automatically |
| Product insight | Reveals what data Jovie should collect or surface in the UI |
| Uncertainty | States missing data and confidence without pretending precision |
| Actionability | Produces tasks an artist manager could execute immediately |

### Best expected answer pattern

The AI should probably recommend:

**Primary move:** use the 1.8M-stream catalog track as the anchor to warm fans and drive presaves for the new single.

**Why:** the catalog track has the strongest proof of affinity, higher save rate, lower skip rate, and enough age to justify reactivation. The upcoming release is 18 days away, so the plan should use catalog momentum to feed a presave funnel.

**Jovie automations to test:**

- Auto-build a presave page.
- Generate segmented fan paths by market and channel.
- Trigger email/SMS reactivation.
- Create playlist pitch variants.
- Recommend which old track to pair with the new release.
- Generate a 30-day launch task board.
- Flag missing data before overcommitting.

This task should produce useful product insight even if the AI fails: the failure modes will show where Jovie needs better data models, campaign templates, artist-facing explanations, or approval workflows.
