...
v0.21.1 unblocks you. The fix lives in `initSchema()` itself, where it should
...
If you've been on v0.13.x, v0.14.x, v0.17.x, v0.18.x, v0.19.x, or v0.20.x and
your `gbrain upgrade` failed, run it again. It should walk to v0.21.1 cleanly.
If you wedged on the v24 RLS migration on a PGLite brain, the same thing.

If you're on a fresh install or already on v0.21.0, this patch is invisible.
