...
v0.22.7 unblocks you. The fix lives in `initSchema()` itself, where it should
...
your `gbrain upgrade` failed, run it again. It should walk to v0.22.7 cleanly.
