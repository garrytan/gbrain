...
v0.21.6 unblocks you. The fix lives in `initSchema()` itself, where it should
...
your `gbrain upgrade` failed, run it again. It should walk to v0.21.6 cleanly.
